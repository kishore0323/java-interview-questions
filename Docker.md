...
- [55 Common Docker Interview Questions](#55-common-docker-interview-questions)
  - [1. What is _Docker_, and how is it different from _virtual machines_?](#1-what-is-docker-and-how-is-it-different-from-virtual-machines)
    ...
    - [Code Example: Dockerfile](#code-example-dockerfile)
    - [Core Unique Features of Docker](#core-unique-features-of-docker)
  - [2. Can you explain what a _Docker image_ is?](#2-can-you-explain-what-a-docker-image-is)
    ...
    - [Advantages of Docker Images](#advantages-of-docker-images)
    - [Code Example: Dockerfile](#code-example-dockerfile-1)
    - [Best Practices for Dockerfiles](#best-practices-for-dockerfiles)
  ...
  - [5. Explain the _Dockerfile_ and its significance in _Docker_.](#5-explain-the-dockerfile-and-its-significance-in-docker)
    ...
    - [Tips for Writing Efficient Dockerfiles](#tips-for-writing-efficient-dockerfiles)
    - [Code Example: Dockerfile for a Node.js Web Server](#code-example-dockerfile-for-a-nodejs-web-server)
  - [6. How does _Docker_ use _layers_ to build images?](#6-how-does-docker-use-layers-to-build-images)
    ...
    - [Image Layering in Docker](#image-layering-in-docker)
    - [Code Overlayers](#code-overlayers)
  - [7. What's the difference between the `COPY` and `ADD` commands in a _Dockerfile_?](#7-whats-the-difference-between-the-copy-and-add-commands-in-a-dockerfile)
    - [Purpose](#purpose)
    - [Key Distinctions](#key-distinctions-1)
    - [Best Practices](#best-practices)
  - [8. What’s the purpose of the `.dockerignore` file?](#8-whats-the-purpose-of-the-dockerignore-file)
  - [9. How would you go about creating a _Docker image_ from an existing _container_?](#9-how-would-you-go-about-creating-a-docker-image-from-an-existing-container)
    - [`docker container commit` Method:](#docker-container-commit-method)
    - [Image Build Process Method:](#image-build-process-method)
      - [Steps:](#steps)
  - [10. In practice, how do you reduce the size of _Docker images_?](#10-in-practice-how-do-you-reduce-the-size-of-docker-images)
    ...
    - [One-Time Execution Commands](#one-time-execution-commands)
    - [Package Managers and Caching](#package-managers-and-caching)
    - [Utilize Glob Patterns for `COPY`](#utilize-glob-patterns-for-copy)
  - [11. What command is used to run a _Docker container_ from an _image_?](#11-what-command-is-used-to-run-a-docker-container-from-an-image)
    ...
    - [Additional Options and Example](#additional-options-and-example)
  - [12. Can you explain what a _Docker namespace_ is and its benefits?](#12-can-you-explain-what-a-docker-namespace-is-and-its-benefits)
    - [Advantages of Docker Namespaces](#advantages-of-docker-namespaces)
    - [Key Namespace Types](#key-namespace-types)
    - [Code Example: Working with Docker Namespaces](#code-example-working-with-docker-namespaces)
  - [13. What is a _Docker volume_, and when would you use it?](#13-what-is-a-docker-volume-and-when-would-you-use-it)
    - [Volume Types](#volume-types)
    - [Use Cases](#use-cases-1)
  - [14. Explain the use and significance of the `docker-compose` tool.](#14-explain-the-use-and-significance-of-the-docker-compose-tool)
  ...
  - [15. Can _Docker containers_ running on the same _host_ communicate with each other by default? If so, how?](#15-can-docker-containers-running-on-the-same-host-communicate-with-each-other-by-default-if-so-how)
      ...
      - [Default Docker Bridge Network](#default-docker-bridge-network)
...
- [docker-cheat-sheet](#docker-cheat-sheet)
    ...
    - [Create,Run,Update and Delete containers](#createrunupdate-and-delete-containers)
      - [Create](#create)
      - [Rename](#rename)
      - [Run](#run)
      - [Update](#update)
    ...
    - [Cleanup commands](#cleanup-commands)
      - [Remove all unused resources](#remove-all-unused-resources)
      - [Images](#images)
...
- [What are 5 similarities between Docker \& Virtual Machine?](#what-are-5-similarities-between-docker--virtual-machine)
- [How is Docker different from Virtual Machine?](#how-is-docker-different-from-virtual-machine)
- [What is the difference between Container Networking \& VM Networking?](#what-is-the-difference-between-container-networking--vm-networking)
- [Is it possible to run multiple process inside Docker container?](#is-it-possible-to-run-multiple-process-inside-docker-container)
- [Does Docker run on Linux, macOS and Windows?](#does-docker-run-on-linux-macos-and-windows)
- [What is DockerHub?](#what-is-dockerhub)
- [What is Dockerfile?](#what-is-dockerfile)
- [How is Dockerfile different from Docker Compose?](#how-is-dockerfile-different-from-docker-compose)
- [Can I use JSON instead of YAML for my Docker Compose file?](#can-i-use-json-instead-of-yaml-for-my-docker-compose-file)
- [How to create Docker container?](#how-to-create-docker-container)
- [What is maximum number of container you can run per host?](#what-is-maximum-number-of-container-you-can-run-per-host)
- [Is it possible to have my own private Docker registry?](#is-it-possible-to-have-my-own-private-docker-registry)
- [Does Docker container package up the entire OS?](#does-docker-container-package-up-the-entire-os)
- [Describe how many ways are available to configure Docker daemon?](#describe-how-many-ways-are-available-to-configure-docker-daemon)
- [What does CNM refers to? What are its components? !\[img\](](#what-does-cnm-refers-to-what-are-its-components-img)
- [What are different types of Docker Networking drivers?](#what-are-different-types-of-docker-networking-drivers)
- [What features are possible only under Docker Enterprise Edition in comparison to Docker Community Edition?](#what-features-are-possible-only-under-docker-enterprise-edition-in-comparison-to-docker-community-edition)
- [How is Docker Bridge network different from traditional Linux bridge ?](#how-is-docker-bridge-network-different-from-traditional-linux-bridge-)
- [How to create a user-defined Bridge network ?](#how-to-create-a-user-defined-bridge-network-)
- [How to delete a user-defined Bridge network ?](#how-to-delete-a-user-defined-bridge-network-)
- [How to connect Docker container to user-defined bridge network?](#how-to-connect-docker-container-to-user-defined-bridge-network)
- [Does Docker support IPv6?](#does-docker-support-ipv6)
- [Does Docker Compose file format support IPv6 protocol?](#does-docker-compose-file-format-support-ipv6-protocol)
- [How is overlay network different from bridge network?](#how-is-overlay-network-different-from-bridge-network)
- [How shall you disable the networking stack on a container?](#how-shall-you-disable-the-networking-stack-on-a-container)
- [How can one create MacVLAN network for Docker container?](#how-can-one-create-macvlan-network-for-docker-container)
- [Is it possible to exclude IP address from being used in MacVLAN network?](#is-it-possible-to-exclude-ip-address-from-being-used-in-macvlan-network)
- [Do I lose my data when the container exits?](#do-i-lose-my-data-when-the-container-exits)
- [Does Docker Enterprise Edition support Kubernetes?](#does-docker-enterprise-edition-support-kubernetes)
- [What is Docker Swarm?](#what-is-docker-swarm)
- [What is `--memory-swap` flag?](#what-is---memory-swap-flag)
- [Can you explain different volume mount types  available in Docker?](#can-you-explain-different-volume-mount-types--available-in-docker)
- [How to share data among DockerHost?](#how-to-share-data-among-dockerhost)
- [How to Backup, Restore, or Migrate data volumes under Docker container?](#how-to-backup-restore-or-migrate-data-volumes-under-docker-container)
- [How to Configure Automated Builds on DockerHub](#how-to-configure-automated-builds-on-dockerhub)
- [How to configure the default logging driver under Docker?](#how-to-configure-the-default-logging-driver-under-docker)
...
- [What’s the difference between up, run, and start under Docker Compose?](#whats-the-difference-between-up-run-and-start-under-docker-compose)
- [What is Docker Trusted Registry?](#what-is-docker-trusted-registry)
- [How to declare default environment variables under Docker Compose?](#how-to-declare-default-environment-variables-under-docker-compose)
- [Can you list out ways to share Compose configurations between files and projects under Docker Compose?](#can-you-list-out-ways-to-share-compose-configurations-between-files-and-projects-under-docker-compose)
- [What is the role of .dockerignore file?](#what-is-the-role-of-dockerignore-file)
- [What is the purpose of EXPOSE command in Dockerfile?](#what-is-the-purpose-of-expose-command-in-dockerfile)
- [How is ENTRYPOINT instruction under Dockerfile different from RUN instruction?](#how-is-entrypoint-instruction-under-dockerfile-different-from-run-instruction)
- [Why Build cache in Docker is so important?](#why-build-cache-in-docker-is-so-important)
- [Why Docker Monitoring is necessary?](#why-docker-monitoring-is-necessary)
- [Difference between Windows Containers and Hyper-V Containers](#difference-between-windows-containers-and-hyper-v-containers)
- [What are main difference between Swarm \& Kubernetes?](#what-are-main-difference-between-swarm--kubernetes)
- [Is it possible to run Kubernetes on Docker EE 2.0 Platform?](#is-it-possible-to-run-kubernetes-on-docker-ee-20-platform)
- [Can you use Docker Compose to build up Swarm/Kubernetes Cluster?](#can-you-use-docker-compose-to-build-up-swarmkubernetes-cluster)
- [What is 'docker stack deploy' command meant for?](#what-is-docker-stack-deploy-command-meant-for)
- [List down major components of Docker EE 2.0?](#list-down-major-components-of-docker-ee-20)
- [Explain the concept of HA under Swarm Mode?](#explain-the-concept-of-ha-under-swarm-mode)
- [docker service create --name nginx --publish 80:80 nginx](#docker-service-create---name-nginx---publish-8080-nginx)
- [Can you explain what is Routing Mesh under Docker Swarm Mode?](#can-you-explain-what-is-routing-mesh-under-docker-swarm-mode)
- [Is Routing Mesh a Load Balancer?](#is-routing-mesh-a-load-balancer)
- [Is it possible to run MacVLAN under Docker Swarm Mode? What features does it offer?](#is-it-possible-to-run-macvlan-under-docker-swarm-mode-what-features-does-it-offer)
- [What are Docker secrets and why is it necessary](#what-are-docker-secrets-and-why-is-it-necessary)
- [Serverless Interview Questions](#serverless-interview-questions)
  - [What is Serverless and why is it important?](#what-is-serverless-and-why-is-it-important)
  - [Why use serverless?](#why-use-serverless)
  - [What are the benefits of serverless?](#what-are-the-benefits-of-serverless)
- [Tell something about the AWS Serverless Platform?](#tell-something-about-the-aws-serverless-platform)
  - [COMPUTE](#compute)
...
- [DCA Mock questions](#dca-mock-questions)
  - [1. How can we limit the number of CPUs provided to a container?](#1-how-can-we-limit-the-number-of-cpus-provided-to-a-container)
  - [2. How can we limit the amount of memory available to a container?](#2-how-can-we-limit-the-amount-of-memory-available-to-a-container)
  - [3.What environment variables should be exported to start using a trusted environment with the Docker client?](#3what-environment-variables-should-be-exported-to-start-using-a-trusted-environment-with-the-docker-client)
- [Deploying a Spring Boot application using Docker and running the Docker container on AWS EC2 instance](#deploying-a-spring-boot-application-using-docker-and-running-the-docker-container-on-aws-ec2-instance)
    - [**Step 1: Dockerize Your Spring Boot Application**](#step-1-dockerize-your-spring-boot-application)
    - [**Step 2: Set Up the EC2 Instance**](#step-2-set-up-the-ec2-instance)
    - [**Step 3: Install Docker on the EC2 Instance**](#step-3-install-docker-on-the-ec2-instance)
    - [**Step 4: Transfer the Docker Image to the EC2 Instance**](#step-4-transfer-the-docker-image-to-the-ec2-instance)
    - [\**Step 5: Run the Docker Container on EC2*](#step-5-run-the-docker-container-on-ec2)
    - [**Step 6: Manage the Docker Container**](#step-6-manage-the-docker-container)
    - [**Step 7: Optional Enhancements (Load Balancer, HTTPS, Auto-restart)**](#step-7-optional-enhancements-load-balancer-https-auto-restart)
    - [**Step 8: Monitoring and Scaling (Optional)**](#step-8-monitoring-and-scaling-optional)
    - [**Docker Commands to Manage the Spring Boot Application**](#docker-commands-to-manage-the-spring-boot-application)
      - [**1. Building the Docker Image**](#1-building-the-docker-image)
      - [**2. Running the Docker Container**](#2-running-the-docker-container)
      - [**3. View Container Logs**](#3-view-container-logs)
      - [**4. Stop and Remove the Container**](#4-stop-and-remove-the-container)
      - [**5. Inspect the Running Container**](#5-inspect-the-running-container)
      - [**6. Pass Environment Variables at Runtime**](#6-pass-environment-variables-at-runtime)
      - [**7. Cleanup Unused Images and Containers**](#7-cleanup-unused-images-and-containers)
      - [When choosing between Docker Swarm and Kubernetes, you can consider factors like:](#when-choosing-between-docker-swarm-and-kubernetes-you-can-consider-factors-like)
