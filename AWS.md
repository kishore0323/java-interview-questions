...
- [100 Essential AWS Interview Questions](#100-essential-aws-interview-questions)
  - [1. What is _Amazon Web Services (AWS)_ and what are its key features?](#1-what-is-amazon-web-services-aws-and-what-are-its-key-features)
    - [Key Features of AWS](#key-features-of-aws)
  - [2. Explain the concept of _Regions_ and _Availability Zones_ in AWS.](#2-explain-the-concept-of-regions-and-availability-zones-in-aws)
    - [AWS Regions](#aws-regions)
    - [AWS Availability Zones](#aws-availability-zones)
    - [Key Characteristics](#key-characteristics)
    - [Benefits of Using Regions and AZs](#benefits-of-using-regions-and-azs)
    - [Considerations for Multi-Region Architectures](#considerations-for-multi-region-architectures)
  - [3. What is an _Amazon Machine Image (AMI)_ and how is it used?](#3-what-is-an-amazon-machine-image-ami-and-how-is-it-used)
    - [Core Components](#core-components)
    - [Unique AMI Features](#unique-ami-features)
    - [Benefits and Use Cases](#benefits-and-use-cases)
    - [AMI IDs in Code](#ami-ids-in-code)
  - [4. Describe the difference between _Elastic IP_ and _Public IP_ in AWS.](#4-describe-the-difference-between-elastic-ip-and-public-ip-in-aws)
    - [Public IP](#public-ip)
    - [Elastic IP](#elastic-ip)
    - [Best Practices](#best-practices)
  - [5. What is the role of the _AWS Management Console_?](#5-what-is-the-role-of-the-aws-management-console)
    - [Key Features](#key-features)
    - [Console vs. SDKs vs. CLIs](#console-vs-sdks-vs-clis)
      - [Key Distinctions](#key-distinctions)
    - [Console Role-Based Access](#console-role-based-access)
  - [6. Explain the concept of _Elastic Computing_ in AWS.](#6-explain-the-concept-of-elastic-computing-in-aws)
    - [Key Features](#key-features-1)
    - [Benefits](#benefits)
    - [Code Example: Auto Scaling Setup](#code-example-auto-scaling-setup)
  - [7. What is _AWS Identity and Access Management (IAM)_ and why is it important?](#7-what-is-aws-identity-and-access-management-iam-and-why-is-it-important)
    - [Key Components](#key-components)
    - [Why IAM is important](#why-iam-is-important)
  - [8. Describe the _AWS Shared Responsibility Model_.](#8-describe-the-aws-shared-responsibility-model)
    - [Security of the Cloud](#security-of-the-cloud)
    - [Security in the Cloud](#security-in-the-cloud)
  - [9. What is the difference between _Vertical Scaling_ and _Horizontal Scaling_ in AWS?](#9-what-is-the-difference-between-vertical-scaling-and-horizontal-scaling-in-aws)
  - [10. Explain the concept of _High Availability_ in AWS.](#10-explain-the-concept-of-high-availability-in-aws)
    - [Core Components for High Availability](#core-components-for-high-availability)
      - [Code Example: Auto Scaling Group](#code-example-auto-scaling-group)
      - [Code Example: Elastic Load Balancer](#code-example-elastic-load-balancer)
    - [AWS Services for High Availability](#aws-services-for-high-availability)
  - [11. What is _Amazon Elastic Compute Cloud (EC2)_ and what are its key features?](#11-what-is-amazon-elastic-compute-cloud-ec2-and-what-are-its-key-features)
    - [Key Features](#key-features-2)
  - [12. Describe the different _EC2 instance types_ and their use cases.](#12-describe-the-different-ec2-instance-types-and-their-use-cases)
    - [General Purpose](#general-purpose)
      - [Use Cases](#use-cases)
      - [Burstable Performance](#burstable-performance)
    - [Compute Optimized](#compute-optimized)
      - [Use Cases](#use-cases-1)
      - [Code Example: c5 Instance](#code-example-c5-instance)
      - [Code Example: t2 Instance](#code-example-t2-instance)
  ...
  - [13. What is _Amazon Elastic Container Service (ECS)_ and how does it work?](#13-what-is-amazon-elastic-container-service-ecs-and-how-does-it-work)
  ...
  - [14. Explain the difference between _Amazon EC2_ and _AWS Lambda_.](#14-explain-the-difference-between-amazon-ec2-and-aws-lambda)
    - [Amazon EC2](#amazon-ec2)
    - [AWS Lambda](#aws-lambda)
      - [Key Distinctions](#key-distinctions-1)
  - [15. What is _AWS Elastic Beanstalk_ and when would you use it?](#15-what-is-aws-elastic-beanstalk-and-when-would-you-use-it)
    - [Key Features](#key-features-4)
    - [When to Use Elastic Beanstalk](#when-to-use-elastic-beanstalk)
    - [Code Example: Basic Elastic Beanstalk Configuration](#code-example-basic-elastic-beanstalk-configuration)
