...
- [MongoDB Interview Questions ( v4.4 )](#mongodb-interview-questions--v44-)
  - [Table of Contents](#table-of-contents)
  - [Q. ***What are NoSQL databases? What are the different types of NoSQL databases?***](#q-what-are-nosql-databases-what-are-the-different-types-of-nosql-databases)
  - [Q. ***What is MongoDB?***](#q-what-is-mongodb)
  - [Q. ***What are Indexes in MongoDB?***](#q-what-are-indexes-in-mongodb)
  - [Q. ***What are the types of Indexes available in MongoDB?***](#q-what-are-the-types-of-indexes-available-in-mongodb)
  - [Q. ***Explain Index Properties in MongoDB?***](#q-explain-index-properties-in-mongodb)
  - [Q. ***How many indexes does MongoDB create by default for a new collection?***](#q-how-many-indexes-does-mongodb-create-by-default-for-a-new-collection)
  - [Q. ***Can you create an index in an array field in MongoDB?***](#q-can-you-create-an-index-in-an-array-field-in-mongodb)
  - [Q. ***Why does Profiler use in MongoDB?***](#q-why-does-profiler-use-in-mongodb)
  - [Q. ***How to remove attribute from MongoDB Object?***](#q-how-to-remove-attribute-from-mongodb-object)
  - [Q. ***What is "Namespace" in MongoDB?***](#q-what-is-namespace-in-mongodb)
  - [Q. ***What is Replication in Mongodb?***](#q-what-is-replication-in-mongodb)
  - [Q. ***What is Replica Set in MongoDB?***](#q-what-is-replica-set-in-mongodb)
  - [Q. ***How does MongoDB ensure high availability?***](#q-how-does-mongodb-ensure-high-availability)
  - [Q. ***What is an Embedded MongoDB Document?***](#q-what-is-an-embedded-mongodb-document)
  - [Q. ***How can you achieve primary key - foreign key relationships in MongoDB?***](#q-how-can-you-achieve-primary-key---foreign-key-relationships-in-mongodb)
  - [Q. ***When should we embed one document within another in MongoDB?***](#q-when-should-we-embed-one-document-within-another-in-mongodb)
  - [Q. ***How is data stored in MongoDB?***](#q-how-is-data-stored-in-mongodb)
  - [Q. ***What are the differences between MongoDB and SQL-SERVER?***](#q-what-are-the-differences-between-mongodb-and-sql-server)
  - [Q. ***How can you achieve transaction and locking in MongoDB?***](#q-how-can-you-achieve-transaction-and-locking-in-mongodb)
  - [Q. ***When to Use MongoDB Rather than MySQL?***](#q-when-to-use-mongodb-rather-than-mysql)
  - [Q. ***How MongoDB supports ACID transactions and locking functionalities?***](#q-how-mongodb-supports-acid-transactions-and-locking-functionalities)
  - [Q. ***What are the best practices for MongoDB Transactions?***](#q-what-are-the-best-practices-for-mongodb-transactions)
  - [Q. ***Explain limitations of MongoDB Transactions?***](#q-explain-limitations-of-mongodb-transactions)
  - [Q. ***Should I normalize my data before storing it in MongoDB?***](#q-should-i-normalize-my-data-before-storing-it-in-mongodb)
  - [Q. ***What is upsert operation in MongoDB?***](#q-what-is-upsert-operation-in-mongodb)
  - [Q. ***Is there an "upsert" option in the mongodb insert command?***](#q-is-there-an-upsert-option-in-the-mongodb-insert-command)
  - [Q. ***What is oplog?***](#q-what-is-oplog)
  - [Q. ***Does MongoDB pushes the writes to disk immediately or lazily?***](#q-does-mongodb-pushes-the-writes-to-disk-immediately-or-lazily)
  - [Q. ***How to perform a delete operation in MongoDB?***](#q-how-to-perform-a-delete-operation-in-mongodb)
  - [Q. ***If you remove a document from database, does MongoDB remove it from disk?***](#q-if-you-remove-a-document-from-database-does-mongodb-remove-it-from-disk)
  - [Q. ***Explain the structure of ObjectID in MongoDB?***](#q-explain-the-structure-of-objectid-in-mongodb)
  - [Q. ***What is a covered query in MongoDB?***](#q-what-is-a-covered-query-in-mongodb)
  - [Q. ***Why MongoDB is not preferred over a 32-bit system?***](#q-why-mongodb-is-not-preferred-over-a-32-bit-system)
  - [Q. ***Can one MongoDB operation lock more than one database?***](#q-can-one-mongodb-operation-lock-more-than-one-database)
  - [Q. ***What is Sharding in MongoDB?***](#q-what-is-sharding-in-mongodb)
  - [Q. ***What is Aggregation in MongoDB?***](#q-what-is-aggregation-in-mongodb)
  - [Q. ***Why are MongoDB data files large in size?***](#q-why-are-mongodb-data-files-large-in-size)
  - [Q. ***How can you isolate your cursors from intervening with the write operations?***](#q-how-can-you-isolate-your-cursors-from-intervening-with-the-write-operations)
  - [Q. ***At what interval does MongoDB write updates to the disk?***](#q-at-what-interval-does-mongodb-write-updates-to-the-disk)
  - [Q. ***What happens if an index does not fit into RAM?***](#q-what-happens-if-an-index-does-not-fit-into-ram)
  - [Q. ***Does MongoDB provide a facility to do text search?***](#q-does-mongodb-provide-a-facility-to-do-text-search)
  - [Q. ***How does Journaling work in MongoDB?***](#q-how-does-journaling-work-in-mongodb)
  - [Q. ***Is MongoDB schema-less?***](#q-is-mongodb-schema-less)
  - [Q. ***What is a Storage Engine in MongoDB?***](#q-what-is-a-storage-engine-in-mongodb)
  - [Q. ***How to condense large volumes of data in Mongodb?***](#q-how-to-condense-large-volumes-of-data-in-mongodb)
  - [Q. ***Explain relationships in MongoDB?***](#q-explain-relationships-in-mongodb)
  - [Q. ***What is use of capped collection in MongoDB?***](#q-what-is-use-of-capped-collection-in-mongodb)
  - [Q. ***What is splitting in MongoDB?***](#q-what-is-splitting-in-mongodb)
  - [Q. ***Explain what is horizontal scalability in mongodb?***](#q-explain-what-is-horizontal-scalability-in-mongodb)
- [MongoDB Commands](#mongodb-commands)
    ...
    - [List of the indexes in a collection](#list-of-the-indexes-in-a-collection)
    - [Drop an existing index](#drop-an-existing-index)
    - [CreateView](#createview)
- [MongoDB Coding Practice](#mongodb-coding-practice)
  - [Q. ***Mention the command to insert a document in a database called company and collection called employee?***](#q-mention-the-command-to-insert-a-document-in-a-database-called-company-and-collection-called-employee)
  - [Q. ***Mention the command to check whether you are on the master server or not?***](#q-mention-the-command-to-check-whether-you-are-on-the-master-server-or-not)
  - [Q. ***How to combine data from multiple collections into one collection?***](#q-how-to-combine-data-from-multiple-collections-into-one-collection)
  - [Q. ***How do I perform the SQL JOIN equivalent in MongoDB?***](#q-how-do-i-perform-the-sql-join-equivalent-in-mongodb)
  - [Q. ***How to query MongoDB with "like"?***](#q-how-to-query-mongodb-with-like)
  - [Q. ***Find objects between two dates MongoDB?***](#q-find-objects-between-two-dates-mongodb)
  - [Q. ***Is it possible to update MongoDB field using value of another field?***](#q-is-it-possible-to-update-mongodb-field-using-value-of-another-field)
  - [Q. ***How to check if a field contains a substring?***](#q-how-to-check-if-a-field-contains-a-substring)
  - [Q. ***How to get the last N records from find?***](#q-how-to-get-the-last-n-records-from-find)
  - [Q. ***How to remove a field completely from a MongoDB document?***](#q-how-to-remove-a-field-completely-from-a-mongodb-document)
  - [Q. ***How to find MongoDB records where array field is not empty?***](#q-how-to-find-mongodb-records-where-array-field-is-not-empty)
  - [Q. ***How to find document with array that contains a specific value?***](#q-how-to-find-document-with-array-that-contains-a-specific-value)
  - [Q. ***Mention the command to remove indexes and list all the indexes on a particular collection?***](#q-mention-the-command-to-remove-indexes-and-list-all-the-indexes-on-a-particular-collection)
  - [Q. ***Select only selected elements from given collection?***](#q-select-only-selected-elements-from-given-collection)
  - [Q. ***How to join 3 or more collections in MongoDB?***](#q-how-to-join-3-or-more-collections-in-mongodb)
    - [Answer](#answer)
