...
- [Spring Quartz vs Spring Batch vs Spring Scheduler](#spring-quartz-vs-spring-batch-vs-spring-scheduler)
    - [**1. Spring Quartz Scheduler**](#1-spring-quartz-scheduler)
      - [**Key Features**](#key-features)
      - [**When to Use Quartz**](#when-to-use-quartz)
      - [**Example Usage**](#example-usage)
    - [**2. Spring Batch**](#2-spring-batch)
      - [**Key Features**](#key-features-1)
      - [**When to Use Spring Batch**](#when-to-use-spring-batch)
      - [**Example Usage**](#example-usage-1)
    - [**3. Spring Scheduler (`@Scheduled` Annotations)**](#3-spring-scheduler-scheduled-annotations)
      - [**Key Features**](#key-features-2)
      - [**When to Use Spring Scheduler**](#when-to-use-spring-scheduler)
      - [**Example Usage**](#example-usage-2)
    - [**Comparison: Spring Quartz vs Spring Batch vs Spring Scheduler**](#comparison-spring-quartz-vs-spring-batch-vs-spring-scheduler)
    - [**Summary of When to Use Each**](#summary-of-when-to-use-each)
- [List of security measures for protecting REST APIs in Spring Boot](#list-of-security-measures-for-protecting-rest-apis-in-spring-boot)
...
- [Types of Auto-Scaling in Kubernetes](#types-of-auto-scaling-in-kubernetes)
    - [**Horizontal Pod Autoscaler (HPA)**](#horizontal-pod-autoscaler-hpa)
      - [**How HPA Works**](#how-hpa-works)
      - [**Configuring HPA**](#configuring-hpa)
      - [**Triggering of HPA**](#triggering-of-hpa)
    - [**Vertical Pod Autoscaler (VPA)**](#vertical-pod-autoscaler-vpa)
      - [**How VPA Works**](#how-vpa-works)
      - [**Configuring VPA**](#configuring-vpa)
    - [**Cluster Autoscaler**](#cluster-autoscaler)
      - [**How Cluster Autoscaler Works**](#how-cluster-autoscaler-works)
      - [**Configuring Cluster Autoscaler**](#configuring-cluster-autoscaler)
      - [**YAML Example for Cluster Autoscaler**](#yaml-example-for-cluster-autoscaler)
    - [**Summary of Auto-Scaling in Kubernetes**](#summary-of-auto-scaling-in-kubernetes)
- [What is Podman?](#what-is-podman)
    - [**How Podman is Used in Kubernetes**](#how-podman-is-used-in-kubernetes)
    - [**Why Use Podman with Kubernetes?**](#why-use-podman-with-kubernetes)
    - [**Integration of Podman with Kubernetes**](#integration-of-podman-with-kubernetes)
    - [**Sample Workflow: Using Podman in a Kubernetes Environment**](#sample-workflow-using-podman-in-a-kubernetes-environment)
    - [**Comparison of Docker and Podman in Kubernetes Context**](#comparison-of-docker-and-podman-in-kubernetes-context)
    - [**Summary: When to Use Podman in Kubernetes**](#summary-when-to-use-podman-in-kubernetes)
- [No ways of hiding elements in Angular](#no-ways-of-hiding-elements-in-angular)
    - [**Using `*ngIf` Directive**](#using-ngif-directive)
      - [**Usage Example**:](#usage-example)
      - [**Explanation**:](#explanation)
      - [**When to Use**:](#when-to-use)
    - [2. **Using `hidden` Attribute**](#2-using-hidden-attribute)
      - [**Usage Example**:](#usage-example-1)
      - [**Explanation**:](#explanation-1)
      - [**When to Use**:](#when-to-use-1)
    - [3. **Using Angular `ngClass` Directive**](#3-using-angular-ngclass-directive)
      - [**Usage Example**:](#usage-example-2)
    - [**Custom Structural Directives**](#custom-structural-directives)
      - [**Example** - Creating a Custom Structural Directive (`*appUnless`)](#example---creating-a-custom-structural-directive-appunless)
        - [**Step 1: Create the Directive**](#step-1-create-the-directive)
        - [**Step 2: Use the Custom Directive**](#step-2-use-the-custom-directive)
      - [**Explanation**:](#explanation-2)
    - [**Key Differences Between Structural Directives and Attribute Directives**](#key-differences-between-structural-directives-and-attribute-directives)
    - [**Best Practices for Using Structural Directives**](#best-practices-for-using-structural-directives)
    - [**Advanced Structural Directive Techniques**](#advanced-structural-directive-techniques)
      - [**Using `<ng-template>`**](#using-ng-template)
        - [**Example**:](#example)
    - [**Summary of Common Structural Directives**](#summary-of-common-structural-directives)
- [Behavioral Directives](#behavioral-directives)
    - [**Key Concepts of Behavioral Directives**](#key-concepts-of-behavioral-directives)
    - [**Built-in Behavioral Directives in Angular**](#built-in-behavioral-directives-in-angular)
    - [**Creating a Custom Behavioral Directive**](#creating-a-custom-behavioral-directive)
      - [**Example - Creating a Custom Directive (`appHighlight`)**](#example---creating-a-custom-directive-apphighlight)
        - [**Step 1: Create the Directive**](#step-1-create-the-directive-1)
        - [**Step 2: Use the Custom Directive**](#step-2-use-the-custom-directive-1)
      - [**Explanation**:](#explanation-3)
    - [**Common Angular Built-in Behavioral Directives**](#common-angular-built-in-behavioral-directives)
    - [**HostBinding and HostListener for Custom Directives**](#hostbinding-and-hostlistener-for-custom-directives)
      - [**`@HostBinding` Example**](#hostbinding-example)
      - [**Explanation**:](#explanation-4)
    - [**Additional Concepts Related to Behavioral Directives**](#additional-concepts-related-to-behavioral-directives)
    - [**Best Practices for Using Behavioral Directives**](#best-practices-for-using-behavioral-directives)
    - [Summary of Behavioral Directives in Angular](#summary-of-behavioral-directives-in-angular)
