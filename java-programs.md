...
- [Java Programs](#java-programs)
  - [Q. Write a function to find out duplicate words in a given string?](#q-write-a-function-to-find-out-duplicate-words-in-a-given-string)
  - [Q. Find the missing number in an array?](#q-find-the-missing-number-in-an-array)
  - [Q. Write a program to generate random numbers between the given range?](#q-write-a-program-to-generate-random-numbers-between-the-given-range)
  - [Q. Write a java program to swap two string variables without using temp variable?](#q-write-a-java-program-to-swap-two-string-variables-without-using-temp-variable)
  - [Q. Write a java program to Move all zeroes to end of array?](#q-write-a-java-program-to-move-all-zeroes-to-end-of-array)
  - [Q. Write a multi-threading program to print odd number using one thread and even number using other?](#q-write-a-multi-threading-program-to-print-odd-number-using-one-thread-and-even-number-using-other)
  - [Q. How to print all permutations of a String in Java?](#q-how-to-print-all-permutations-of-a-string-in-java)
  - [Q. Reverse the string with preserving the position of spaces](#q-reverse-the-string-with-preserving-the-position-of-spaces)
  - [Q. How do you find longest substring without repeating characters in a string?](#q-how-do-you-find-longest-substring-without-repeating-characters-in-a-string)
  - [Q. A Program to check if strings are rotations of each other or not?](#q-a-program-to-check-if-strings-are-rotations-of-each-other-or-not)
  - [Q. Can you write a regular expression to check if String is a number?](#q-can-you-write-a-regular-expression-to-check-if-string-is-a-number)
  - [Q. Write a program to find top two maximum numbers in a array?](#q-write-a-program-to-find-top-two-maximum-numbers-in-a-array)
  - [Q. How to find all the leaders in an integer array in java?](#q-how-to-find-all-the-leaders-in-an-integer-array-in-java)
  - [Q. Write a java program to find number of characters, number of words and number of lines in a text file?](#q-write-a-java-program-to-find-number-of-characters-number-of-words-and-number-of-lines-in-a-text-file)
  - [Q. Find all pairs of elements whose sum is equal to given number?](#q-find-all-pairs-of-elements-whose-sum-is-equal-to-given-number)
  - [Q. Program to convert lower to upper case without using toUppercase()?](#q-program-to-convert-lower-to-upper-case-without-using-touppercase)
  - [Q. Write a program to create deadlock between two threads?](#q-write-a-program-to-create-deadlock-between-two-threads)
  - [Q. How to find the word with the highest frequency from a file in Java?](#q-how-to-find-the-word-with-the-highest-frequency-from-a-file-in-java)
  - [Q. How to sort a text file in java?](#q-how-to-sort-a-text-file-in-java)
  - [Q. Find middle index of array where both ends sum is equal?](#q-find-middle-index-of-array-where-both-ends-sum-is-equal)
  - [Q. What do the expression 1.0 / 0.0 will return? will it throw Exception? any compile time error?](#q-what-do-the-expression-10--00-will-return-will-it-throw-exception-any-compile-time-error)
  - [Q. How do you check the equality of two arrays in java?](#q-how-do-you-check-the-equality-of-two-arrays-in-java)
  - [Q. How to remove duplicate elements from ArrayList in java?](#q-how-to-remove-duplicate-elements-from-arraylist-in-java)
  - [Q. Write a java program to append text to a file?](#q-write-a-java-program-to-append-text-to-a-file)
  - [Q. Write a program to sort a map by value?](#q-write-a-program-to-sort-a-map-by-value)
  - [Q. How to find duplicate number on Integer array in Java?](#q-how-to-find-duplicate-number-on-integer-array-in-java)
  - [Q. How to find largest and smallest number in unsorted array?](#q-how-to-find-largest-and-smallest-number-in-unsorted-array)
  - [Q. FizzBuzz problem:- Write a program which return "fizz" if the number is a multiplier of 3, return "buzz" if its multiplier of 5 and return "fizzbuzz" if the number is divisible by both 3 and 5. If the number is not divisible by either 3 or 5 then it should just return the number itself?](#q-fizzbuzz-problem--write-a-program-which-return-fizz-if-the-number-is-a-multiplier-of-3-return-buzz-if-its-multiplier-of-5-and-return-fizzbuzz-if-the-number-is-divisible-by-both-3-and-5-if-the-number-is-not-divisible-by-either-3-or-5-then-it-should-just-return-the-number-itself)
  - [Q. Write a Comparator in Java to compare two employees based upon their name, departments and age?](#q-write-a-comparator-in-java-to-compare-two-employees-based-upon-their-name-departments-and-age)
  - [Q. Write a program to convert Decimal To Binary, Decimal To Octal and Decimal to HexaDecimal in Java?](#q-write-a-program-to-convert-decimal-to-binary-decimal-to-octal-and-decimal-to-hexadecimal-in-java)
  - [Q. How to rearrange array in alternating positive and negative number?](#q-how-to-rearrange-array-in-alternating-positive-and-negative-number)
  ...
  - [Q. Find the shortest-path weights d(s, v) from given source s for all vertices v present in the graph.](#q-find-the-shortest-path-weights-ds-v-from-given-source-s-for-all-vertices-v-present-in-the-graph)
      - [Q. How to find if there is a sub array with sum equal to zero?](#q-how-to-find-if-there-is-a-sub-array-with-sum-equal-to-zero)
      - [Q. How to remove a given element from array in Java?](#q-how-to-remove-a-given-element-from-array-in-java)
      - [Q. How to find trigonometric values of an angle in java?](#q-how-to-find-trigonometric-values-of-an-angle-in-java)
      - [Q. Reverse and add until you get a palindrome](#q-reverse-and-add-until-you-get-a-palindrome)
      - [Q. Selection sort in java](#q-selection-sort-in-java)
      - [Q. Write a singleton class in java?](#q-write-a-singleton-class-in-java)
      - [Q. How to calculate complexity of algorithm?](#q-how-to-calculate-complexity-of-algorithm)
      - [Q. Implement Producer Consumer design Pattern in Java using wait, notify and notifyAll method in Java?](#q-implement-producer-consumer-design-pattern-in-java-using-wait-notify-and-notifyall-method-in-java)
      - [Q. Find Minimum numbers of platforms required for railway station in java](#q-find-minimum-numbers-of-platforms-required-for-railway-station-in-java)
      - [Q. How to check whether given number is binary or not?](#q-how-to-check-whether-given-number-is-binary-or-not)
      - [Q. Armstrong number program in java](#q-armstrong-number-program-in-java)
      - [Q. How to find sum of all digits of a number in java?](#q-how-to-find-sum-of-all-digits-of-a-number-in-java)
      - [Q. How to find largest number less than a given number and without a given digit?](#q-how-to-find-largest-number-less-than-a-given-number-and-without-a-given-digit)
      - [Q. Roman equivalent of a decimal number](#q-roman-equivalent-of-a-decimal-number)
      - [Q. How to check whether user input is number or not in java?](#q-how-to-check-whether-user-input-is-number-or-not-in-java)
      - [Q. Write a program to convert decimal number to binary format.](#q-write-a-program-to-convert-decimal-number-to-binary-format)
      - [Q. Write a program to find perfect number or not.](#q-write-a-program-to-find-perfect-number-or-not)
      - [Q. Write a program to find sum of each digit in the given number using recursion.](#q-write-a-program-to-find-sum-of-each-digit-in-the-given-number-using-recursion)
      - [Q. Write a program to check the given number is a prime number or not?](#q-write-a-program-to-check-the-given-number-is-a-prime-number-or-not)
      - [Q. Write a program to check the given number is binary number or not?](#q-write-a-program-to-check-the-given-number-is-binary-number-or-not)
      - [Q. Find prime factors of number in java](#q-find-prime-factors-of-number-in-java)
      - [Q. Write code to avoid deadlock in Java where N threads are accessing N shared resources?](#q-write-code-to-avoid-deadlock-in-java-where-n-threads-are-accessing-n-shared-resources)
      - [Q. How to sort an array in place using QuickSort algorithm?](#q-how-to-sort-an-array-in-place-using-quicksort-algorithm)
      - [Q. Write a program to find intersection of two sorted arrays in Java?](#q-write-a-program-to-find-intersection-of-two-sorted-arrays-in-java)
      - [Q. How find the first repeating element in an array of integers?](#q-how-find-the-first-repeating-element-in-an-array-of-integers)
      - [Q. How to find first non-repeating element in array of integers?](#q-how-to-find-first-non-repeating-element-in-array-of-integers)
      - [Q. How to find top two numbers from an integer array?](#q-how-to-find-top-two-numbers-from-an-integer-array)
      - [Q. How to find the smallest positive integer value that cannot be represented as sum of any subset of a given array?](#q-how-to-find-the-smallest-positive-integer-value-that-cannot-be-represented-as-sum-of-any-subset-of-a-given-array)
      - [Q. How to merge sorted array?](#q-how-to-merge-sorted-array)
      - [Q. How to find sub array with maximum sum in an array of positive and negative number?](#q-how-to-find-sub-array-with-maximum-sum-in-an-array-of-positive-and-negative-number)
      - [Q. How to find sub array with largest product in array of both positive and negative number?](#q-how-to-find-sub-array-with-largest-product-in-array-of-both-positive-and-negative-number)
      - [Q. Write a program to find length of longest consecutive sequence in array of integers?](#q-write-a-program-to-find-length-of-longest-consecutive-sequence-in-array-of-integers)
      - [Q. How to find minimum value in a rotated sorted array?](#q-how-to-find-minimum-value-in-a-rotated-sorted-array)
      - [Q. Given an array of of size n and a number k, find all elements that appear more than n/k times?](#q-given-an-array-of-of-size-n-and-a-number-k-find-all-elements-that-appear-more-than-nk-times)
      - [Q. Returns the largest sum of contiguous integers in the array](#q-returns-the-largest-sum-of-contiguous-integers-in-the-array)
      - [Q. Return the sum two largest integers in an array](#q-return-the-sum-two-largest-integers-in-an-array)
      - [Q. How to search an array to check if an element exists there?](#q-how-to-search-an-array-to-check-if-an-element-exists-there)
      - [Q. How to copy array in Java?](#q-how-to-copy-array-in-java)
      - [Q. Write a function to find out longest palindrome in a given string?](#q-write-a-function-to-find-out-longest-palindrome-in-a-given-string)
      - [Q. Can you make array volatile in Java?](#q-can-you-make-array-volatile-in-java)
      - [Q. How to find top two numbers from an integer array in Java?](#q-how-to-find-top-two-numbers-from-an-integer-array-in-java)
      - [Q. Can you pass the negative number as an array size?](#q-can-you-pass-the-negative-number-as-an-array-size)
      - [Q. What is an anonymous array? Give example?](#q-what-is-an-anonymous-array-give-example)
      - [Q. What is the difference between int\[\] a and int a\[\] ?](#q-what-is-the-difference-between-int-a-and-int-a-)
      - [Q. What are jagged arrays in java? Give example?](#q-what-are-jagged-arrays-in-java-give-example)
      - [Q. While creating the multidimensional arrays, can you specify an array dimension after an empty dimension?](#q-while-creating-the-multidimensional-arrays-can-you-specify-an-array-dimension-after-an-empty-dimension)
      - [Q. How to reverse Singly Linked List?](#q-how-to-reverse-singly-linked-list)
      - [Q. Create a Java program to find middle node of linked list in Java in one pass?](#q-create-a-java-program-to-find-middle-node-of-linked-list-in-java-in-one-pass)
      - [Q. How to find if a linked list contains cycle or not in Java?](#q-how-to-find-if-a-linked-list-contains-cycle-or-not-in-java)
      - [Q. How to find nth element from end of linked list](#q-how-to-find-nth-element-from-end-of-linked-list)
      - [Q. How to check if linked list is palindrome in java](#q-how-to-check-if-linked-list-is-palindrome-in-java)
      - [Q. Add two numbers represented by linked list in java](#q-add-two-numbers-represented-by-linked-list-in-java)
      - [Q. How to sort a Stack using a temporary Stack?](#q-how-to-sort-a-stack-using-a-temporary-stack)
      - [Q. Implement Binary Search Tree (BST)](#q-implement-binary-search-tree-bst)
      - [Q. Find min and max value from Binary Search Tree (BST)](#q-find-min-and-max-value-from-binary-search-tree-bst)
      - [Q. Find height of a Binary Search Tree (BST)](#q-find-height-of-a-binary-search-tree-bst)
      - [Q. Implement Binary Search Tree (BST) Level order traversal (breadth first).](#q-implement-binary-search-tree-bst-level-order-traversal-breadth-first)
      - [Q. Implement Binary Search Tree (BST) pre-order traversal (depth first).](#q-implement-binary-search-tree-bst-pre-order-traversal-depth-first)
      - [Q. Implement Binary Search Tree (BST) in-order traversal (depth first).](#q-implement-binary-search-tree-bst-in-order-traversal-depth-first)
      - [Q. Implement Binary Search Tree (BST) post-order traversal (depth first).](#q-implement-binary-search-tree-bst-post-order-traversal-depth-first)
      - [Q. How to check the given Binary Tree is Binary Search Tree (BST) or not?](#q-how-to-check-the-given-binary-tree-is-binary-search-tree-bst-or-not)
      - [Q. How to delete a node from Binary Search Tree (BST)?](#q-how-to-delete-a-node-from-binary-search-tree-bst)
      - [Q. Binary tree level order traversal](#q-binary-tree-level-order-traversal)
      - [Q. Binary tree spiral order traversal](#q-binary-tree-spiral-order-traversal)
      - [Q. Binary tree reverse level order traversal](#q-binary-tree-reverse-level-order-traversal)
      - [Q. Binary tree boundary traversal](#q-binary-tree-boundary-traversal)
      - [Q. Print leaf nodes of binary tree](#q-print-leaf-nodes-of-binary-tree)
      - [Q. Count leaf nodes in binary tree](#q-count-leaf-nodes-in-binary-tree)
      - [Q. Get maximum element in binary tree](#q-get-maximum-element-in-binary-tree)
      - [Q. Print all paths from root to leaf in binary tree](#q-print-all-paths-from-root-to-leaf-in-binary-tree)
      - [Q. Print vertical sum of binary tree in java](#q-print-vertical-sum-of-binary-tree-in-java)
      - [Q. Get level of node in binary tree in java](#q-get-level-of-node-in-binary-tree-in-java)
      - [Q. Lowest common ancestor(LCA) in binary tree in java](#q-lowest-common-ancestorlca-in-binary-tree-in-java)
      - [Q. Search element in row wise and column wise sorted matrix](#q-search-element-in-row-wise-and-column-wise-sorted-matrix)
      - [Q. Stock buy and sell to maximize profit.](#q-stock-buy-and-sell-to-maximize-profit)
      - [Q. How to implement merge sort in java](#q-how-to-implement-merge-sort-in-java)
      - [Q. How to implement bubble sort in java](#q-how-to-implement-bubble-sort-in-java)
      - [Q. How to implement insertion sort in java](#q-how-to-implement-insertion-sort-in-java)
      - [Q. Write a program to implement hashcode and equals.](#q-write-a-program-to-implement-hashcode-and-equals)
      - [Q. Write wait-notify code for producer-consumer problem?](#q-write-wait-notify-code-for-producer-consumer-problem)
      - [Q. Write a program to implement ArrayList.](#q-write-a-program-to-implement-arraylist)
      - [Q. A maximal subarray](#q-a-maximal-subarray)
      - [Q. Sort a linked list](#q-sort-a-linked-list)
      - [Q. Iterative Quick sort](#q-iterative-quick-sort)
      - [Q. Bucket sort](#q-bucket-sort)
      - [Q. Counting sort](#q-counting-sort)
      - [Q. Square root of number](#q-square-root-of-number)
      - [Q. Printing patterns](#q-printing-patterns)
      - [Q. Leap year](#q-leap-year)
      - [Q. Design a Vending Machine](#q-design-a-vending-machine)
      - [Q. Transpose a matrix](#q-transpose-a-matrix)
      - [Q. Adding two matrices in Java](#q-adding-two-matrices-in-java)
      - [Q. Matrix multiplication](#q-matrix-multiplication)
      - [Q. Write a java program to print Floyd’s Triangle?](#q-write-a-java-program-to-print-floyds-triangle)
      - [Q. Spiral Matrix Program.](#q-spiral-matrix-program)
      - [Q. Anagram program in java](#q-anagram-program-in-java)
      - [Q. Write a program to print fibonacci series.](#q-write-a-program-to-print-fibonacci-series)
      - [Q. How to you calculate the difference between two dates in Java?](#q-how-to-you-calculate-the-difference-between-two-dates-in-java)
      - [Q. Java Program to find gcd and lcm of two numbers](#q-java-program-to-find-gcd-and-lcm-of-two-numbers)
      - [Q. Write a program to find the sum of the first 1000 prime numbers?](#q-write-a-program-to-find-the-sum-of-the-first-1000-prime-numbers)
      - [Q. How to perform matrix operations in java?](#q-how-to-perform-matrix-operations-in-java)
