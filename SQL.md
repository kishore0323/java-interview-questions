...
- [**Cracking the SQL Interview**](#cracking-the-sql-interview)
- [100 Must-Know SQL Interview Questions](#100-must-know-sql-interview-questions)
  - [1. What is _SQL_ and what is it used for?](#1-what-is-sql-and-what-is-it-used-for)
    - [Core Components](#core-components)
    - [Common Database Management Tasks](#common-database-management-tasks)
    - [Basic SQL Commands](#basic-sql-commands)
    - [Code Example: Basic SQL Queries](#code-example-basic-sql-queries)
  - [2. Describe the difference between _SQL_ and _NoSQL_ databases.](#2-describe-the-difference-between-sql-and-nosql-databases)
    - [Top-Level Differences](#top-level-differences)
    - [Common NoSQL Database Types](#common-nosql-database-types)
      - [Document Stores](#document-stores)
      - [Key-Value Stores](#key-value-stores)
      - [Wide-Column Stores (Column Families)](#wide-column-stores-column-families)
      - [Graph Databases](#graph-databases)
    - [Data Modeling Differences](#data-modeling-differences)
    - [Auto-Incrementing IDs](#auto-incrementing-ids)
    - [Handling Data Relationships](#handling-data-relationships)
  ...
  - [3. What are the different types of _SQL commands_?](#3-what-are-the-different-types-of-sql-commands)
    - [Data Query Language (DQL)](#data-query-language-dql)
      - [Keywords and Examples:](#keywords-and-examples)
    - [Data Definition Language (DDL)](#data-definition-language-ddl)
      - [Keywords and Examples:](#keywords-and-examples-1)
    - [Data Manipulation Language (DML)](#data-manipulation-language-dml)
      - [Keywords and Examples:](#keywords-and-examples-2)
    - [Data Control Language (DCL)](#data-control-language-dcl)
      - [Keywords and Examples:](#keywords-and-examples-3)
  - [4. Explain the purpose of the _SELECT_ statement.](#4-explain-the-purpose-of-the-select-statement)
    - [Key Components of the SELECT Statement](#key-components-of-the-select-statement)
    - [Practical Applications of SELECT](#practical-applications-of-select)
    - [SELECT Query Example](#select-query-example)
  - [5. What is the difference between _WHERE_ and _HAVING_ clauses?](#5-what-is-the-difference-between-where-and-having-clauses)
    - [WHERE Clause](#where-clause)
    - [HAVING Clause](#having-clause)
  - [6. Define what a _JOIN_ is in SQL and list its types.](#6-define-what-a-join-is-in-sql-and-list-its-types)
    ...
    - [Self Join](#self-join)
  - [7. What is a _primary key_ in a database?](#7-what-is-a-primary-key-in-a-database)
    - [Key Characteristics](#key-characteristics)
    - [Data Integrity Benefits](#data-integrity-benefits)
    - [Performance Advantages](#performance-advantages)
    - [Industry Best Practice](#industry-best-practice)
    - [Code Example: Declaring a Primary Key](#code-example-declaring-a-primary-key)
  - [8. Explain what a _foreign key_ is and how it is used.](#8-explain-what-a-foreign-key-is-and-how-it-is-used)
    - [Key Functions of a Foreign Key](#key-functions-of-a-foreign-key)
    - [Foreign Key Constraints](#foreign-key-constraints)
    - [Use Cases and Best Practices](#use-cases-and-best-practices)
    - [Code Example: Creating a Foreign Key Relationship](#code-example-creating-a-foreign-key-relationship)
  - [9. How can you prevent _SQL injections_?](#9-how-can-you-prevent-sql-injections)
    - [Parameterized Queries](#parameterized-queries)
    - [Stored Procedures](#stored-procedures)
    - [Input Validation](#input-validation)
    - [Code Filtering](#code-filtering)
  - [10. What is _normalization_? Explain with examples.](#10-what-is-normalization-explain-with-examples)
    - [Normalization in Action](#normalization-in-action)
      - [Unnormalized Table (0NF)](#unnormalized-table-0nf)
      ...
      - [Third Normal Form (3NF)](#third-normal-form-3nf)
        - [Updated Invoices Table](#updated-invoices-table)
    - [Practical Implications](#practical-implications)
    - [Real-World Usage](#real-world-usage)
    - [Code Example: Implementing 3NF](#code-example-implementing-3nf)
  - [11. Describe the concept of _denormalization_ and when you would use it.](#11-describe-the-concept-of-denormalization-and-when-you-would-use-it)
    - [Common Techniques for Denormalization](#common-techniques-for-denormalization)
    - [Common Use Cases](#common-use-cases)
    - [Considerations and Trade-offs](#considerations-and-trade-offs)
  - [12. What are _indexes_ and how can they improve query performance?](#12-what-are-indexes-and-how-can-they-improve-query-performance)
    - [How Do Indexes Improve Performance?](#how-do-indexes-improve-performance)
    - [Index Types](#index-types)
    - [When to Use Carefully](#when-to-use-carefully)
    - [Best Practices](#best-practices)
    - [Types of Keys](#types-of-keys)
  - [13. Explain the purpose of the _GROUP BY_ clause.](#13-explain-the-purpose-of-the-group-by-clause)
  ...
  - [14. What is a _subquery_, and when would you use one?](#14-what-is-a-subquery-and-when-would-you-use-one)
    - [Common Subquery Types](#common-subquery-types)
      - [Scalar Subquery](#scalar-subquery)
      - [Table Subquery](#table-subquery)
    - [Advantages of Using Subqueries](#advantages-of-using-subqueries)
    - [Limitations and Optimization](#limitations-and-optimization)
    - [Code Example: Using Subqueries](#code-example-using-subqueries)
  - [15. Describe the functions of the _ORDER BY_ clause.](#15-describe-the-functions-of-the-order-by-clause)
    - [Key Features](#key-features)
    - [Use Cases](#use-cases)
    - [Code Example: Order by Multiple Columns and Limit Results](#code-example-order-by-multiple-columns-and-limit-results)
    - [SQL Server Specific: Order by Column Position](#sql-server-specific-order-by-column-position)
    - [MySQL Specific: Random Order](#mysql-specific-random-order)
  - [A comprehensive guide before your next interview](#a-comprehensive-guide-before-your-next-interview)
        - [“What is the difference between SQL and PL/SQL? or Difference between SQL and PL/SQL:](#what-is-the-difference-between-sql-and-plsql-or-difference-between-sql-and-plsql)
      - [**SQL vs. PL-SQL**](#sql-vs-pl-sql)
