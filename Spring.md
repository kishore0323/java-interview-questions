...
- [100 Fundamental Spring Interview Questions](#100-fundamental-spring-interview-questions)
  - [1. What is the _Spring Framework_ and what are its core features?](#1-what-is-the-spring-framework-and-what-are-its-core-features)
    - [Core Features](#core-features)
  - [2. How do you create a simple _Spring_ application?](#2-how-do-you-create-a-simple-spring-application)
    - [Project Setup](#project-setup)
    - [Key Components for a Web Application](#key-components-for-a-web-application)
    - [Spring Application Main Class](#spring-application-main-class)
    - [WebController](#webcontroller)
  - [3. What is _Inversion of Control (IoC)_? How does _Spring_ facilitate _IoC_?](#3-what-is-inversion-of-control-ioc-how-does-spring-facilitate-ioc)
    - [How does Spring Support IoC?](#how-does-spring-support-ioc)
    - [Java Example: IoC with Spring](#java-example-ioc-with-spring)
      - [Maven Dependency](#maven-dependency)
      - [Bean Configuration (XML)](#bean-configuration-xml)
      - [Bean Configuration (Annotations)](#bean-configuration-annotations)
      - [Application Entry Point: Main](#application-entry-point-main)
  - [4. What is the _ApplicationContext_ in _Spring_?](#4-what-is-the-applicationcontext-in-spring)
    - [How It Works](#how-it-works)
    - [Bean Scopes](#bean-scopes)
    - [Common `ApplicationContext` Implementations](#common-applicationcontext-implementations)
    - [Close vs. Refresh](#close-vs-refresh)
    - [Code Example: Initializing the `ApplicationContext`](#code-example-initializing-the-applicationcontext)
    - [Best Practices](#best-practices)
  - [5. Explain _Dependency Injection_ and its types in the _Spring_ context.](#5-explain-dependency-injection-and-its-types-in-the-spring-context)
    - [Benefits](#benefits)
    - [What DI Solves](#what-di-solves)
    - [Core Components](#core-components)
    - [Types of Dependency Injection](#types-of-dependency-injection)
    - [Code Example: Dependency Injection Types](#code-example-dependency-injection-types)
  - [6. What are _Bean Scopes_ in _Spring_? Name them.](#6-what-are-bean-scopes-in-spring-name-them)
    - [Types of Bean Scopes](#types-of-bean-scopes)
  - [7. How do you configure a _bean_ in _Spring_?](#7-how-do-you-configure-a-bean-in-spring)
    - [Key Bean Configuration Elements](#key-bean-configuration-elements)
    - [Annotation-Based Bean Configuration](#annotation-based-bean-configuration)
    - [XML-Based Bean Configuration](#xml-based-bean-configuration)
    - [Java Configuration](#java-configuration)
  - [8. Describe the role of the _Spring Core container_.](#8-describe-the-role-of-the-spring-core-container)
    - [Key Responsibilities](#key-responsibilities)
    - [Primary Components](#primary-components)
    - [Registration and Location of Beans](#registration-and-location-of-beans)
    - [Bean Scopes](#bean-scopes-1)
      - [Primary Scopes](#primary-scopes)
      - [Extended Scopes](#extended-scopes)
    - [Custom Scopes](#custom-scopes)
    - [IoC and DI Mechanisms](#ioc-and-di-mechanisms)
    - [Practical Benefits](#practical-benefits)
  - [9. What is a _Spring configuration file_?](#9-what-is-a-spring-configuration-file)
    - [Key Elements](#key-elements)
    - [Roles and Responsibilities](#roles-and-responsibilities)
    - [Best Practices](#best-practices-1)
    - [Code Example: Spring Configuration File](#code-example-spring-configuration-file)
  - [10. How do you create an _ApplicationContext_ in a _Spring_ application?](#10-how-do-you-create-an-applicationcontext-in-a-spring-application)
    - [Ways to Create ApplicationContext](#ways-to-create-applicationcontext)
    - [Best Practices](#best-practices-2)
  - [11. What is _Aspect-Oriented Programming (AOP)_?](#11-what-is-aspect-oriented-programming-aop)
    - [Core Concepts](#core-concepts)
    - [Benefits of AOP](#benefits-of-aop)
    - [AOP in Spring](#aop-in-spring)
  - [12. How does _Spring_ support _AOP_?](#12-how-does-spring-support-aop)
    ...
    - [AOP Concepts in Practice](#aop-concepts-in-practice)
    - [Code Example: AspectJ Around Advice](#code-example-aspectj-around-advice)
  - [13. Can you explain a _Pointcut_ and an _Advice_ in _Spring AOP_?](#13-can-you-explain-a-pointcut-and-an-advice-in-spring-aop)
    - [Using Pointcuts](#using-pointcuts)
    - [Code Examples: Pointcuts \& Advice](#code-examples-pointcuts--advice)
    - [Aspect-Oriented Programming in Spring](#aspect-oriented-programming-in-spring)
    - [Type of Advices](#type-of-advices)
    - [Additional Mechanisms to Aid Debugging](#additional-mechanisms-to-aid-debugging)
  - [14. What is a _Join Point_ in _Spring AOP_?](#14-what-is-a-join-point-in-spring-aop)
    - [Common Join Points](#common-join-points)
    - [AspectJ-Exclusive Join Points](#aspectj-exclusive-join-points)
    - [Code Example: Join Points](#code-example-join-points)
  - [15. What is the difference between a _Concern_ and a _Cross-cutting Concern_ in _Spring AOP_?](#15-what-is-the-difference-between-a-concern-and-a-cross-cutting-concern-in-spring-aop)
    - [Examples of Cross-Cutting Concerns](#examples-of-cross-cutting-concerns)
    - [Code Example: Cross-Cutting Concerns in Spring AOP](#code-example-cross-cutting-concerns-in-spring-aop)
