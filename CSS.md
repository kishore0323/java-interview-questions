...
- [100 Fundamental CSS Interview Questions](#100-fundamental-css-interview-questions)
      - [You can also find all 100 answers here 👉 Devinterview.io - CSS](#you-can-also-find-all-100-answers-here--devinterviewio---css)
  - [1. What does _CSS_ stand for and what is its primary use?](#1-what-does-css-stand-for-and-what-is-its-primary-use)
    - [Key Concepts](#key-concepts)
    - [Visual Example](#visual-example)
  - [2. How do you include _CSS_ in your _HTML document_?](#2-how-do-you-include-css-in-your-html-document)
    - [Methods of CSS Integration](#methods-of-css-integration)
    - [Key Considerations](#key-considerations)
    - [Best Practices](#best-practices)
    - [HTML Code Example: Methods Northwind.CSS](#html-code-example-methods-northwindcss)
  - [3. Can you explain the difference between _class_ and _ID selectors_?](#3-can-you-explain-the-difference-between-class-and-id-selectors)
    - [Selectivity and Applicability](#selectivity-and-applicability)
    - [Efficiency and Performance](#efficiency-and-performance)
    - [Common Use Cases](#common-use-cases)
    - [Code Example: Class and ID Selectors](#code-example-class-and-id-selectors)
  - [4. What are _pseudo-classes_ in _CSS_?](#4-what-are-pseudo-classes-in-css)
    - [Categories of Pseudo-Classes](#categories-of-pseudo-classes)
  - [5. Describe how to implement a _CSS reset_ and why it is useful.](#5-describe-how-to-implement-a-css-reset-and-why-it-is-useful)
    - [Benefits of CSS Reset](#benefits-of-css-reset)
    - [The Code](#the-code)
  - [6. How do you select elements by _attribute_ in _CSS_?](#6-how-do-you-select-elements-by-attribute-in-css)
    - [Benefits](#benefits)
    - [Variations](#variations)
  - [7. What is a _pseudo-element_, and what are they used for?](#7-what-is-a-pseudo-element-and-what-are-they-used-for)
    - [Key Features](#key-features)
    - [Practical Applications](#practical-applications)
  - [8. Explain the difference between the _child combinator_ and the _descendant combinator_.](#8-explain-the-difference-between-the-child-combinator-and-the-descendant-combinator)
    - [Distinct Characteristics](#distinct-characteristics)
    - [Code Example](#code-example)
    - [Best Practices for Combinator Use](#best-practices-for-combinator-use)
  - [9. How would you select all direct _children elements_ of a particular type?](#9-how-would-you-select-all-direct-children-elements-of-a-particular-type)
  - [10. What are the _universal selector_ and the _sibling combinator_, and when would you use them?](#10-what-are-the-universal-selector-and-the-sibling-combinator-and-when-would-you-use-them)
    - [When To Use Sibling Combinator](#when-to-use-sibling-combinator)
      - [Code Example: Universal Selector](#code-example-universal-selector)
      - [Code Example: Sibling Combinator](#code-example-sibling-combinator)
    - [Case Study: Practical Applications](#case-study-practical-applications)
      - [Resetting Margins and Paddings](#resetting-margins-and-paddings)
  - [11. What is the _CSS Box Model_?](#11-what-is-the-css-box-model)
    - [Box Model Components](#box-model-components)
    - [Visual Representation](#visual-representation)
    - [Key Attributes](#key-attributes)
    - [Code Example: Box Model](#code-example-box-model)
    - [Margins](#margins)
      - [Auto Margins](#auto-margins)
    - [Parent and Child Element Interplay](#parent-and-child-element-interplay)
      - [Box Sizing](#box-sizing)
  - [12. Explain _margin collapsing_.](#12-explain-margin-collapsing)
    - [Types of Margin Collapsing](#types-of-margin-collapsing)
    - [Visual Representation of Margin Collapsing](#visual-representation-of-margin-collapsing)
    - [Preventing Margin Collapsing](#preventing-margin-collapsing)
    - [CSS Rules and Margin Collapsing](#css-rules-and-margin-collapsing)
  - [13. What are the different values for the _box-sizing_ property and what do they do?](#13-what-are-the-different-values-for-the-box-sizing-property-and-what-do-they-do)
    - [Visual Representation](#visual-representation-1)
  - [14. How do you center a _block element_ with _CSS_?](#14-how-do-you-center-a-block-element-with-css)
    - [Horizontal Centering](#horizontal-centering)
      - [Code Example: Auto Margins](#code-example-auto-margins)
      - [Code Example: Flexbox](#code-example-flexbox)
    - [Vertical Centering](#vertical-centering)
      - [Code Example: Flexbox](#code-example-flexbox-1)
      - [Code Example: CSS Grid](#code-example-css-grid)
  - [15. What is the difference between _block_, _inline_, and _inline-block elements_?](#15-what-is-the-difference-between-block-inline-and-inline-block-elements)
    - [Code Example: Key Differences](#code-example-key-differences)
      - [Explore all 100 answers here 👉 Devinterview.io - CSS](#explore-all-100-answers-here--devinterviewio---css)
