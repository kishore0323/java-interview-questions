...
- [Java 8 Interview Questions and Answers](#java-8-interview-questions-and-answers)
  - [Q. What are the important features of Java 8 release?](#q-what-are-the-important-features-of-java-8-release)
  - [Q. Can you declare an interface method static?](#q-can-you-declare-an-interface-method-static)
  - [Q. What is a lambda?](#q-what-is-a-lambda)
  - [Q. What variables do lambda expressions have access to?](#q-what-variables-do-lambda-expressions-have-access-to)
  - [Q. How to sort a list of strings using a lambda expression?](#q-how-to-sort-a-list-of-strings-using-a-lambda-expression)
  - [Q. What is a method reference?](#q-what-is-a-method-reference)
  - [Q. What types of method references do you know?](#q-what-types-of-method-references-do-you-know)
  - [Q. Explain the expression `System.out::println`?](#q-explain-the-expression-systemoutprintln)
  - [Q. What is a Functional Interface?](#q-what-is-a-functional-interface)
  - [Q. What is StringJoiner?](#q-what-is-stringjoiner)
  - [Q. What are `default`interface methods?](#q-what-are-defaultinterface-methods)
  - [Q. How to call `default` interface method in a class that implements this interface?](#q-how-to-call-default-interface-method-in-a-class-that-implements-this-interface)
  - [Q. What is `static` interface method?](#q-what-is-static-interface-method)
  - [Q. How to call `static` interface method?](#q-how-to-call-static-interface-method)
  - [Q. What is Optional](#q-what-is-optional)
  - [Q. What is Stream?](#q-what-is-stream)
  - [Q. What are the ways to create a stream?](#q-what-are-the-ways-to-create-a-stream)
  - [Q. What is the difference between `Collection` and `Stream`?](#q-what-is-the-difference-between-collection-and-stream)
  - [Q. What is the method `collect()`for streams for?](#q-what-is-the-method-collectfor-streams-for)
  - [Q. Why do streams use `forEach()`and `forEachOrdered()` methods?](#q-why-do-streams-use-foreachand-foreachordered-methods)
  - [Q. What are `map()`, `mapToInt()`, `mapToDouble()` and `mapToLong()` methods in Stream?](#q-what-are-map-maptoint-maptodouble-and-maptolong-methods-in-stream)
  - [Q. What is the purpose of `filter()` method in streams?](#q-what-is-the-purpose-of-filter-method-in-streams)
  - [Q. What is the use of `limit()` method in streams?](#q-what-is-the-use-of-limit-method-in-streams)
  - [Q. What is the use of `sorted()` method in streams?](#q-what-is-the-use-of-sorted-method-in-streams)
  - [Q. What streamers designed methods `flatMap()`, `flatMapToInt()`, `flatMapToDouble()`, `flatMapToLong()`?](#q-what-streamers-designed-methods-flatmap-flatmaptoint-flatmaptodouble-flatmaptolong)
  - [Q. Tell us about parallel processing in Java 8?](#q-tell-us-about-parallel-processing-in-java-8)
  - [Q. What are the final methods of working with streams you know?](#q-what-are-the-final-methods-of-working-with-streams-you-know)
  - [Q. What intermediate methods of working with streams do you know?](#q-what-intermediate-methods-of-working-with-streams-do-you-know)
  - [Q. How to display 10 random numbers using forEach()?](#q-how-to-display-10-random-numbers-using-foreach)
  - [Q. How can I display unique squares of numbers using the method map()?](#q-how-can-i-display-unique-squares-of-numbers-using-the-method-map)
  - [Q. How to display the number of empty lines using the method filter()?](#q-how-to-display-the-number-of-empty-lines-using-the-method-filter)
  - [Q. How to display 10 random numbers in ascending order?](#q-how-to-display-10-random-numbers-in-ascending-order)
  - [Q. How to find the maximum number in a set?](#q-how-to-find-the-maximum-number-in-a-set)
  - [Q. How to find the minimum number in a set?](#q-how-to-find-the-minimum-number-in-a-set)
  - [Q. How to get the sum of all numbers in a set?](#q-how-to-get-the-sum-of-all-numbers-in-a-set)
  - [Q. How to get the average of all numbers?](#q-how-to-get-the-average-of-all-numbers)
  - [Q. What additional methods for working with associative arrays (maps) appeared in Java 8?](#q-what-additional-methods-for-working-with-associative-arrays-maps-appeared-in-java-8)
  - [Q. What is LocalDateTime?](#q-what-is-localdatetime)
  - [Q. What is ZonedDateTime?](#q-what-is-zoneddatetime)
  - [Q. How to get current date using Date Time API from Java 8?](#q-how-to-get-current-date-using-date-time-api-from-java-8)
  - [Q. How to add 1 week, 1 month, 1 year, 10 years to the current date using the Date Time API?](#q-how-to-add-1-week-1-month-1-year-10-years-to-the-current-date-using-the-date-time-api)
  - [Q. How to get the next Tuesday using the Date Time API?](#q-how-to-get-the-next-tuesday-using-the-date-time-api)
  - [Q. How to get the current time accurate to milliseconds using the Date Time API?](#q-how-to-get-the-current-time-accurate-to-milliseconds-using-the-date-time-api)
  - [Q. How to get the second Saturday of the current month using the Date Time API?](#q-how-to-get-the-second-saturday-of-the-current-month-using-the-date-time-api)
  - [Q. How to get the current time in local time accurate to milliseconds using the Date Time API?](#q-how-to-get-the-current-time-in-local-time-accurate-to-milliseconds-using-the-date-time-api)
  - [Q. How to determine repeatable annotation?](#q-how-to-determine-repeatable-annotation)
  - [Q. What is Nashorn?](#q-what-is-nashorn)
  - [Q. What is jjs?](#q-what-is-jjs)
  - [Q. What class appeared in Java 8 for encoding / decoding data?](#q-what-class-appeared-in-java-8-for-encoding--decoding-data)
  - [Q. How to create a Base64 encoder and decoder?](#q-how-to-create-a-base64-encoder-and-decoder)
  - [Q. What are the functional interfaces `Function<T,R>`, `DoubleFunction<R>`, `IntFunction<R>` and `LongFunction<R>`?](#q-what-are-the-functional-interfaces-functiontr-doublefunctionr-intfunctionr-and-longfunctionr)
  - [Q. What are the functional interfaces `UnaryOperator<T>`, `DoubleUnaryOperator`, `IntUnaryOperator`and `LongUnaryOperator`?](#q-what-are-the-functional-interfaces-unaryoperatort-doubleunaryoperator-intunaryoperatorand-longunaryoperator)
  - [Q. What are the functional interfaces `BinaryOperator<T>`, `DoubleBinaryOperator`, `IntBinaryOperator`and `LongBinaryOperator`?](#q-what-are-the-functional-interfaces-binaryoperatort-doublebinaryoperator-intbinaryoperatorand-longbinaryoperator)
  - [Q. What are the functional interfaces `Predicate<T>`, `DoublePredicate`, `IntPredicateand` `LongPredicate`?](#q-what-are-the-functional-interfaces-predicatet-doublepredicate-intpredicateand-longpredicate)
  - [Q. What are the functional interfaces `Consumer<T>`, `DoubleConsumer`, `IntConsumer`and `LongConsumer`?](#q-what-are-the-functional-interfaces-consumert-doubleconsumer-intconsumerand-longconsumer)
  - [Q. What are the functional interfaces `Supplier<T>`, `BooleanSupplier`, `DoubleSupplier`, `IntSupplier`and `LongSupplier`?](#q-what-are-the-functional-interfaces-suppliert-booleansupplier-doublesupplier-intsupplierand-longsupplier)
      - [Q. When do we go for Java 8 Stream API?](#q-when-do-we-go-for-java-8-stream-api)
      - [Q. Why do we need to use Java 8 Stream API in our projects?](#q-why-do-we-need-to-use-java-8-stream-api-in-our-projects)
      - [Q. Explain Differences between Collection API and Stream API?](#q-explain-differences-between-collection-api-and-stream-api)
      - [Q. What is Spliterator in Java SE 8? Differences between Iterator and Spliterator in Java SE 8?](#q-what-is-spliterator-in-java-se-8-differences-between-iterator-and-spliterator-in-java-se-8)
      - [Q. What is Optional in Java 8? What is the use of Optional?](#q-what-is-optional-in-java-8-what-is-the-use-of-optional)
      - [Q. What is Type Inference? Is Type Inference available in older versions like Java 7 and Before 7 or it is available only in Java SE 8?](#q-what-is-type-inference-is-type-inference-available-in-older-versions-like-java-7-and-before-7-or-it-is-available-only-in-java-se-8)
      - [Q. What is differences between Functional Programming and Object-Oriented Programming?](#q-what-is-differences-between-functional-programming-and-object-oriented-programming)
