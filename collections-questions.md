...
- [Collections Interview Questions and Answers](#collections-interview-questions-and-answers)
  - [Q. What is Java Collections Framework? List out some benefits of Collections framework?](#q-what-is-java-collections-framework-list-out-some-benefits-of-collections-framework)
  - [Q. What will be the problem if you do not override hashcode() method?](#q-what-will-be-the-problem-if-you-do-not-override-hashcode-method)
  - [Q. What is the benefit of Generics in Collections Framework?](#q-what-is-the-benefit-of-generics-in-collections-framework)
  - [Q. How do WeakHashMap works?](#q-how-do-weakhashmap-works)
  - [Q. What is difference between Array and ArrayList?](#q-what-is-difference-between-array-and-arraylist)
  - [Q. What is difference between ArrayList and LinkedList?](#q-what-is-difference-between-arraylist-and-linkedlist)
  - [Q. What is difference between Comparable and Comparator interface?](#q-what-is-difference-between-comparable-and-comparator-interface)
  - [Q. How to remove duplicates from ArrayList?](#q-how-to-remove-duplicates-from-arraylist)
  - [Q. What is Java Priority Queue?](#q-what-is-java-priority-queue)
  - [Q. What is LinkedHashMap in Java?](#q-what-is-linkedhashmap-in-java)
  - [Q. What are different Collection views provided by Map interface?](#q-what-are-different-collection-views-provided-by-map-interface)
  - [Q. What is difference between HashMap and Hashtable?](#q-what-is-difference-between-hashmap-and-hashtable)
  - [Q. What is EnumSet?](#q-what-is-enumset)
  - [Q. What is the difference between fail-fast and fail-safe iterator?](#q-what-is-the-difference-between-fail-fast-and-fail-safe-iterator)
  - [Q. What are concurrent collection classes?](#q-what-are-concurrent-collection-classes)
  - [Q. What is BlockingQueue? How to implement producer-consumer problem by using BlockingQueue?](#q-what-is-blockingqueue-how-to-implement-producer-consumer-problem-by-using-blockingqueue)
  - [Q. What is difference between Enumeration and Iterator interface?](#q-what-is-difference-between-enumeration-and-iterator-interface)
  - [Q. What is difference between Iterator and ListIterator?](#q-what-is-difference-between-iterator-and-listiterator)
  - [Q. How can we create a synchronized collection from given collection?](#q-how-can-we-create-a-synchronized-collection-from-given-collection)
  - [Q. What is a default capacity of ArrayList, Vector, HashMap, Hashtable and Hashset?](#q-what-is-a-default-capacity-of-arraylist-vector-hashmap-hashtable-and-hashset)
  - [Q. What is the difference between Collection and Collections?](#q-what-is-the-difference-between-collection-and-collections)
  - [Q. What is the difference between HashSet and TreeSet?](#q-what-is-the-difference-between-hashset-and-treeset)
  - [Q. What is the difference between Set and Map?](#q-what-is-the-difference-between-set-and-map)
  - [Q. What is the difference between HashSet and HashMap?](#q-what-is-the-difference-between-hashset-and-hashmap)
  - [Q. What is the difference between HashMap and TreeMap?](#q-what-is-the-difference-between-hashmap-and-treemap)
  - [Q. What is the Dictionary class?](#q-what-is-the-dictionary-class)
  - [Q. What are all the Classes and Interfaces that are available in the collections?](#q-what-are-all-the-classes-and-interfaces-that-are-available-in-the-collections)
  - [Q. What is the difference between HashMap and ConcurrentHashMap?](#q-what-is-the-difference-between-hashmap-and-concurrenthashmap)
  - [Q. What is CopyOnWriteArrayList? How it is different from ArrayList in Java?](#q-what-is-copyonwritearraylist-how-it-is-different-from-arraylist-in-java)
  - [Q. How to make an ArrayList read only in Java?](#q-how-to-make-an-arraylist-read-only-in-java)
  - [Q. Why Collection doesn’t extend Cloneable and Serializable interfaces?](#q-why-collection-doesnt-extend-cloneable-and-serializable-interfaces)
  - [Q. Why ConcurrentHashMap is faster than Hashtable in Java?](#q-why-concurrenthashmap-is-faster-than-hashtable-in-java)
  - [Q. What is the difference between peek(), poll() and remove() method of the Queue interface?](#q-what-is-the-difference-between-peek-poll-and-remove-method-of-the-queue-interface)
  - [Q. How HashMap works in Java?](#q-how-hashmap-works-in-java)
  - [Q. How does HashMap handle collisions in java?](#q-how-does-hashmap-handle-collisions-in-java)
  - [Q. Write a code to convert HashMap to ArrayList.](#q-write-a-code-to-convert-hashmap-to-arraylist)
  - [Q. What is difference between arrayList and linkedList?](#q-what-is-difference-between-arraylist-and-linkedlist-1)
  - [Q. How Set/HashSet implement unique values?](#q-how-sethashset-implement-unique-values)
  ...
  - [Q. If you store Employee object as key say: Employee emp = new Employee(“name1”,20); store it in a HashMap as key, now if we add a new parameter emp.setMarriedStatus(true) and try to override it what will happen?](#q-if-you-store-employee-object-as-key-say-employee-emp--new-employeename120-store-it-in-a-hashmap-as-key-now-if-we-add-a-new-parameter-empsetmarriedstatustrue-and-try-to-override-it-what-will-happen)
    - [Q. Why Map interface does not extend Collection interface?](#q-why-map-interface-does-not-extend-collection-interface)
    - [Q. What is CompareAndSwap approach?](#q-what-is-compareandswap-approach)
