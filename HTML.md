...
- [100 Essential HTML5 Interview Questions](#100-essential-html5-interview-questions)
      - [You can also find all 100 answers here 👉 Devinterview.io - HTML5](#you-can-also-find-all-100-answers-here--devinterviewio---html5)
  - [1. What does _HTML_ stand for and what is its purpose?](#1-what-does-html-stand-for-and-what-is-its-purpose)
    - [Core Functionalities](#core-functionalities)
    - [Compatibility and Development](#compatibility-and-development)
    - [Visual Presentation and User Interface Adaptations](#visual-presentation-and-user-interface-adaptations)
    - [The Role of CSS and JavaScript](#the-role-of-css-and-javascript)
    - [Practical Uses](#practical-uses)
  - [2. Describe the basic structure of an _HTML document_.](#2-describe-the-basic-structure-of-an-html-document)
    - [Basic Structure of an HTML Document](#basic-structure-of-an-html-document)
      - [Document Type Declaration (DOCTYPE)](#document-type-declaration-doctype)
      - [HTML Element](#html-element)
      - [Head Section](#head-section)
        - [Title Element](#title-element)
      - [Body Section](#body-section)
  - [3. What do _DOCTYPE_ and _html lang_ attributes do?](#3-what-do-doctype-and-html-lang-attributes-do)
    - [DOCTYPE: Defining Document Type and Validation Mode](#doctype-defining-document-type-and-validation-mode)
      - [Purpose](#purpose)
      - [Code Example](#code-example)
    - [Lang Attribute: Language Specification](#lang-attribute-language-specification)
      - [Code Example](#code-example-1)
  - [4. What is the difference between _head_ and _body_ tags?](#4-what-is-the-difference-between-head-and-body-tags)
    - [Key Distinctions](#key-distinctions)
      - [1. Role and Content](#1-role-and-content)
      - [2. Placement in the HTML File](#2-placement-in-the-html-file)
      - [3. Common Elements in Each Section](#3-common-elements-in-each-section)
    - [Visual Representation in the HTML File](#visual-representation-in-the-html-file)
  - [5. Can you explain the purpose of _meta tags_ in HTML?](#5-can-you-explain-the-purpose-of-meta-tags-in-html)
    - [Key Meta Tags](#key-meta-tags)
    - [Code Example: Common Meta Tags](#code-example-common-meta-tags)
    - [Responsible Use of Meta Tags](#responsible-use-of-meta-tags)
  - [6. How do you link a _CSS file_ to an _HTML document_?](#6-how-do-you-link-a-css-file-to-an-html-document)
    - [HTML Link Tag: `<link>`](#html-link-tag-link)
      - [Syntax](#syntax)
      - [Code Example: Using the Link Tag](#code-example-using-the-link-tag)
  - [7. How do you link a _JavaScript file_ to an _HTML document_?](#7-how-do-you-link-a-javascript-file-to-an-html-document)
    - [External Script File](#external-script-file)
      - [Best Practices](#best-practices)
    - [Inline Script](#inline-script)
      - [Best Practices](#best-practices-1)
    - [Example HTML File](#example-html-file)
    - [Implementation: HTML File](#implementation-html-file)
  - [8. How do you add a _comment_ in HTML and why would you use them?](#8-how-do-you-add-a-comment-in-html-and-why-would-you-use-them)
    - [Role of Comments in Development](#role-of-comments-in-development)
    - [Best Practices for Using Comments](#best-practices-for-using-comments)
    - [When are Comments Unnecessary?](#when-are-comments-unnecessary)
  - [9. How do you serve your page in multiple _languages_?](#9-how-do-you-serve-your-page-in-multiple-languages)
    - [Language Tag](#language-tag)
    - [Common Language Codes](#common-language-codes)
    - [SEO Considerations](#seo-considerations)
    - [AI-Clearance Required](#ai-clearance-required)
  - [10. What are _data-_\* attributes and when should they be used?](#10-what-are-data--attributes-and-when-should-they-be-used)
    - [Core Benefits](#core-benefits)
    - [Code Example: Using Data Attributes](#code-example-using-data-attributes)
    - [Appropriate Use-Cases](#appropriate-use-cases)
  - [11. What is the difference between _b_ and _strong_ tags?](#11-what-is-the-difference-between-b-and-strong-tags)
    - [Bold vs. Strong](#bold-vs-strong)
    - [Semantic Importance](#semantic-importance)
    - [Code Example: B vs. Strong](#code-example-b-vs-strong)
    - [General Best Practice](#general-best-practice)
  - [12. When would you use _em_ over _i_, and vice versa?](#12-when-would-you-use-em-over-i-and-vice-versa)
    - [When to Use 'em'](#when-to-use-em)
    - [When to Use 'i'](#when-to-use-i)
  - [13. What is the purpose of _small_, _s_, and _mark_ tags?](#13-what-is-the-purpose-of-small-s-and-mark-tags)
    - [`<small>`](#small)
      - [Use Case](#use-case)
    - [`<s>`](#s)
      - [Use Case](#use-case-1)
    ...
    - [`<mark>`](#mark)
      - [Use Case](#use-case-2)
  - [14. What are _semantic HTML tags_ and why are they important?](#14-what-are-semantic-html-tags-and-why-are-they-important)
    - [Benefits of Semantic Tags](#benefits-of-semantic-tags)
    - [Common Semantic Tags](#common-semantic-tags)
    - [Necessary vs. Optional Tags](#necessary-vs-optional-tags)
    - [Code Example: Before vs. After Semantic HTML](#code-example-before-vs-after-semantic-html)
      - [Before Semantic HTML](#before-semantic-html)
      - [After Implementing Semantic Tags](#after-implementing-semantic-tags)
  - [15. How do you create a _paragraph_ or a _line break_ in HTML?](#15-how-do-you-create-a-paragraph-or-a-line-break-in-html)
    - [Paragraphs in HTML](#paragraphs-in-html)
      - [Syntax](#syntax-1)
      - [Visual Representation](#visual-representation-1)
    - [Line Breaks in HTML](#line-breaks-in-html)
      - [Syntax](#syntax-2)
      - [Visual Representation](#visual-representation-2)
    - [Multi-line Text Elements](#multi-line-text-elements)
      - [Syntax](#syntax-3)
      - [Visual Representation](#visual-representation-3)
      - [Explore all 100 answers here 👉 Devinterview.io - HTML5](#explore-all-100-answers-here--devinterviewio---html5)
